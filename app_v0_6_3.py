...
st.title("WoRP Lab")
st.caption("USER → LEAGUE → GRAPH · Engine V0.2.1 frozen · UI V0.6.3")
...
if not user:
    ...
    st.info("V0.6.3: concept-first positional curve + click-to-hide legend + automatic structural insights.")
    st.stop()
