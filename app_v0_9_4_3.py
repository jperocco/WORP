    ...
    with tab_curve:
        ...
        try:
            ...
            if envelope["source"]=="EXACT_HISTORICAL_SUPPORT":
                ...
                st.caption("League-native derived envelope · lower validation. Calculated from this league's team count, slot eligibility, active roster capacity and WoRP curve — not from Wookiee or a nearest-format substitute. Positional bounds are non-additive.")
