...
from worp_roster_construction_product_v0_9_4 import recover_v0_32_ranges, roster_construction_envelope
...
if not has_result:
    ...
    with tab_curve:
        ...
        try:
            ...
            st.caption("Once meaningful Scoring capacity is satisfied, remaining roster capacity belongs to Non-Scoring optionality.")
        except Exception as exc:
