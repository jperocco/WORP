...
st.title("WoRP Lab")
st.caption("USER → LEAGUE → GRAPH · Engine V0.2.1 frozen · UI V0.9.4.7")
...
if not has_result:
    ...
    with tab_curve:
        ...
        try:
            ...
            render_roster_scenarios(
                envelope, active_roster_size, league.get("roster_positions", []),
                league["league_id"], league.get("scoring_settings", {}),
            )
        except Exception as exc:
...
st.caption(
    "WoRP Lab UI V0.9.4.7 · Sleeper-native scoring · Engine V0.2.1 frozen."
)
