...
# Add the scoring-only lineup model. This intentionally does not consume WoRP.
...
helper='from worp_lineup_economics_v0_9_4 import build_lineup_scoring_share\n\n'
...
ui=r'''        st.markdown("##### Lineup Economics")
...
print('Lineup Economics rebuilt from fantasy points only; WoRP removed from panel')
