#!/usr/bin/env python3
"""
WOOKIEE WR HISTORICAL ECONOMIC CURVE AUDIT V1.1
...
print("="*110)
print("WOOKIEE WR HISTORICAL ECONOMIC CURVE AUDIT V1.1")
print("="*110)
...
# Exact frozen-engine API: LeagueSettings uses per-team slot counts.
...
for season in SEASONS:
    ...
    # Exact frozen-engine API.
    weekly, rankings = calculate_season_worp(
        season_df,
        settings,
