...
print("=" * 88)
print("WOOKIEE WR THRESHOLD AUDIT V3 — REAL SLEEPER FORMAT + SCORING")
print("=" * 88)
...
for season in SEASONS:
    ...
    for week in range(1, 19):
        ...
        # Sleeper weekly stats may return either:
        # 1) dict keyed by player_id, or
        # 2) list of records containing player_id + stats.
        # Accept both explicitly; fail loudly on any unknown shape.
        if isinstance(raw, dict):
            ...
            for rec in raw:
                ...
                stats = rec.get("stats")
                if stats is None:
                    # Defensive fallback if stats fields are flattened.
                    stats = {
            ...
            raise SystemExit(
                ...
                f"formato inesperado do endpoint Sleeper: {type(raw).__name__}"
            )
